...
//clear example lists
for(var i = 0; i < 3; i++) {
  var examples = document.getElementsByTagName("li")[0];
  examples.remove();
}
...
//fist button:
var addButton = document.getElementsByTagName("button")[0]; //incomplete-tasks:
...
var addTask = function() {
  ...
  if (taskInput.value === "") {
    taskInput.value = "Enter a Task";
    taskInput.onfocus = this.value ="";  //Not working!
  } else {
